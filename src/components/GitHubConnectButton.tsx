  ...
  return (
    <div className="font-sans-pro">
      <Button 
        ...
        disabled={isLoading}
        variant="outline"
        className="w-full py-4 px-4 sm:px-6 bg-transparent border-foreground hover:bg-muted/10 text-foreground font-medium transition-all duration-200 hover:transform hover:-translate-y-1 hover:shadow-lg flex items-center justify-center gap-2 sm:gap-3 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none relative overflow-hidden rounded-sm min-h-[48px] text-sm sm:text-base"
      >
      {isLoading ? (
        <>
        ...
        <>
          <svg className="w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24" fill="currentColor">
